...
import wish.wurmatron.common.items.ItemCrystal;
...
import wish.wurmatron.common.items.ItemShard;
  ...
  public void modelBakeEvent(ModelRegistryEvent e) {
    for (StoneType type : StoneType.values()) {
      if (type.getType() == StoneType.RockType.Metamorphic) {
        ...
        createModel(WishBlocks.chiselMetamorphic, type.getId(),
            "chisel_" + type.getName().toLowerCase());
      ...
      if (type.getType() == StoneType.RockType.Sedimentary) {
        ...
        createModel(WishBlocks.brickSedimentary, type.getId(),
            "brick_" + type.getName().toLowerCase());
        createModel(WishBlocks.chiselSedimentary, type.getId(),
            "chisel_" + type.getName().toLowerCase());
      ...
      if (type.getType() == StoneType.RockType.Igneous) {
        ...
        createModel(WishBlocks.chiselIgneous, type.getId(),
            "chisel_" + type.getName().toLowerCase());
