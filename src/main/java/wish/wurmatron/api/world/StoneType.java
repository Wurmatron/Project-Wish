...
public enum StoneType {
  ...
  SANDSTONE("Sandstone", 1, RockType.Sedimentary, SubType.CLASTIC),
  SHALE("Shale", 2, RockType.Sedimentary, SubType.CLASTIC),
  LIMESTONE("Limestone", 3, RockType.Sedimentary, SubType.CHEMICAL),
  DOLOMITE("Dolomite", 4, RockType.Sedimentary, SubType.CHEMICAL),
  SALT("Salt", 5, RockType.Sedimentary, SubType.CHEMICAL),
  ...
  SCHIST("Schist", 2, RockType.Metamorphic, SubType.FOLIATED),
  SLATE("Slate", 3, RockType.Metamorphic, SubType.FOLIATED),
  ...
  SKARN("Skarn", 8, RockType.Metamorphic, SubType.NONFOLIATED),
  // Igneous
  GABBRO("Gabbro", 0, RockType.Igneous, SubType.INTRUSIVE),
  GRANITE("Granite", 1, RockType.Igneous, SubType.INTRUSIVE),
  PEGMATITE("Pegmatite", 2, RockType.Igneous, SubType.INTRUSIVE),
  DIORITE("Diorite", 3, RockType.Igneous, SubType.EXTRUSIVE),
  ANDESITE("Andesite", 4, RockType.Igneous, SubType.EXTRUSIVE),
  BASALT("Basalt", 5, RockType.Igneous, SubType.EXTRUSIVE),
  OBSIDIAN("Obsidian", 6, RockType.Igneous, SubType.EXTRUSIVE),
  RHYOLITE("Rhyolite", 7, RockType.Igneous, SubType.EXTRUSIVE),
  SCORIA("Scoria", 8, RockType.Igneous, SubType.EXTRUSIVE);
