...
public interface Ore {
  ...
  /**
   * StoneType this WishOre can spawn in if no value is set all RockTypes will be used
   */
  ...
  /**
   * Minimum and Maxiumum Height this ore can spawn in null or -1 means any
   */
  int[] getMinMaxHeight();

  /**
   * Places an ore into the world based on the StoneType (If ores needs a tile make sure to add it
   * here
   *
  ...
  /**
   * Determines if the player is affected by radioactivity while near this block without correct
   * protection
   */
