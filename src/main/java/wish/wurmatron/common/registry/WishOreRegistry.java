...
public class WishOreRegistry implements OreRegistry {
	...
	public void createDefaultOres () {
		Ore ironOre = new WishOre ("hemetite",new StoneType.RockType[] {StoneType.RockType.Sedimentary},new StoneType[] {},new String[] {},100000,100000,new WishGeneration (8,150,1,Generation.Style.CLUSTER));
		saveOre (ironOre);
	}
}
