...
public class WishModBlocks {
	...
	public static void registerBlocks () {
		...
		// Ores
		WishBlocks.orePetalite = register (new BlockWishOre (Material.ROCK,OreType.PETALITE).setUnlocalizedName ("orePetalite"),OreType.PETALITE);
		WishBlocks.oreLignite = register (new BlockWishOre (Material.ROCK,OreType.LIGNITE).setUnlocalizedName ("oreLignite"),OreType.LIGNITE);
		WishBlocks.oreBituminous = register (new BlockWishOre (Material.ROCK,OreType.BITUMINOUS).setUnlocalizedName ("oreBituminous"),OreType.BITUMINOUS);
		WishBlocks.oreAnthracite = register (new BlockWishOre (Material.ROCK,OreType.ANTHRACITE).setUnlocalizedName ("oreAnthracite"),OreType.ANTHRACITE);
		WishBlocks.oreMagnesite = register (new BlockWishOre (Material.ROCK,OreType.MAGNESITE).setUnlocalizedName ("oreMagnesite"),OreType.MAGNESITE);
		WishBlocks.oreBauxite = register (new BlockWishOre (Material.ROCK,OreType.BAUXITE).setUnlocalizedName ("oreBauxite"),OreType.BAUXITE);
		WishBlocks.oreRutile = register (new BlockWishOre (Material.ROCK,OreType.RUTILE).setUnlocalizedName ("oreRutile"),OreType.RUTILE);
		WishBlocks.oreIlmenite = register (new BlockWishOre (Material.ROCK,OreType.Ilmenite).setUnlocalizedName ("oreIlmenite"),OreType.Ilmenite);
		WishBlocks.oreChromite = register (new BlockWishOre (Material.ROCK,OreType.CHROMITE).setUnlocalizedName ("oreChromite"),OreType.CHROMITE);
		WishBlocks.oreMagnetite = register (new BlockWishOre (Material.ROCK,OreType.MAGNETITE).setUnlocalizedName ("oreMagnetite"),OreType.MAGNETITE);
		WishBlocks.oreHematite = register (new BlockWishOre (Material.ROCK,OreType.HEMATITE).setUnlocalizedName ("oreHematite"),OreType.HEMATITE);
		WishBlocks.oreLimonite = register (new BlockWishOre (Material.ROCK,OreType.LIMONITE).setUnlocalizedName ("oreLimonite"),OreType.LIMONITE);
		WishBlocks.oreSiderite = register (new BlockWishOre (Material.ROCK,OreType.SIDERITE).setUnlocalizedName ("oreSiderite"),OreType.SIDERITE);
		WishBlocks.oreCassiterite = register (new BlockWishOre (Material.ROCK,OreType.CASSITERITE).setUnlocalizedName ("oreCassiterite"),OreType.CASSITERITE);
		WishBlocks.oreCobaltite = register (new BlockWishOre (Material.ROCK,OreType.COBALTITE).setUnlocalizedName ("oreCobaltite"),OreType.COBALTITE);
		WishBlocks.oreTetrahedrite = register (new BlockWishOre (Material.ROCK,OreType.TETRAHEDRITE).setUnlocalizedName ("oreTetrahedrite"),OreType.TETRAHEDRITE);
		WishBlocks.oreMalachite = register (new BlockWishOre (Material.ROCK,OreType.MALACHITE).setUnlocalizedName ("oreMalachite"),OreType.MALACHITE);
		WishBlocks.oreSphalerite = register (new BlockWishOre (Material.ROCK,OreType.SPHALERITE).setUnlocalizedName ("oreSphalerite"),OreType.SPHALERITE);
		WishBlocks.oreGold = register (new BlockWishOre (Material.ROCK,OreType.GOLD).setUnlocalizedName ("oreGold"),OreType.GOLD);
		WishBlocks.oreGalena = register (new BlockWishOre (Material.ROCK,OreType.GALENA).setUnlocalizedName ("oreGalena"),OreType.GALENA);
		WishBlocks.oreBismuthinite = register (new BlockWishOre (Material.ROCK,OreType.BISMUTHINITE).setUnlocalizedName ("oreBismuthinite"),OreType.BISMUTHINITE);
		WishBlocks.oreMonazite = register (new BlockWishOre (Material.ROCK,OreType.MONAZITE).setUnlocalizedName ("oreMonazite"),OreType.MONAZITE);
		WishBlocks.oreUranium = register (new BlockWishOre (Material.ROCK,OreType.URANIUM).setUnlocalizedName ("oreUranium"),OreType.URANIUM);
		WishBlocks.oreGarnierite = register (new BlockWishOre (Material.ROCK,OreType.GARNIERITE).setUnlocalizedName ("oreGarnierite"),OreType.GARNIERITE);
		WishBlocks.orePentlandite = register (new BlockWishOre (Material.ROCK,OreType.PENTALANDITE).setUnlocalizedName ("orePentlandite"),OreType.PENTALANDITE);
		WishBlocks.oreCinnabar = register (new BlockWishOre (Material.ROCK,OreType.CINNABAR).setUnlocalizedName ("oreCinnabar"),OreType.CINNABAR);
		// Rocks
