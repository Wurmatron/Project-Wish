...
public class BlockLeaf3 extends BlockLeaves {
	...
	public BlockLeaf3 () {
		this.setDefaultState (this.blockState.getBaseState ().withProperty (VARIANT,TreeType.SPRUCE).withProperty (CHECK_DECAY,true).withProperty (DECAYABLE,true));
