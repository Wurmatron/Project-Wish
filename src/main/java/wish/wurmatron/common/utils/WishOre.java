...
public class WishOre implements Ore {
    ...
    public String[] getNames () {
        ...
        if (names.size () > 16) {
            ProjectWish.logger.error ("Ore " + getUnlocalizedName () + " has more than 16 types, thus some of them have" + " " + "been removed");
        }
        return names.size () > 16 ? Arrays.copyOfRange (names.toArray (new String[0]),0,15) : names.toArray (new String[0]);
    }
}
