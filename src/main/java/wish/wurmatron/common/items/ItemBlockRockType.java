...
public class ItemBlockRockType extends ItemBlock {
	...
	public String getItemStackDisplayName (ItemStack stack) {
		...
		if (stack.getItem ().getRegistryName ().getResourcePath ().startsWith ("cobble"))
			return I18n.translateToLocal ("item.stone" + stoneType.getName () + ".name") + " " + I18n.translateToLocal ("display.cobblestone.name");
		else if (stack.getItem ().getRegistryName ().getResourcePath ().startsWith ("smooth"))
			return I18n.translateToLocal ("display.smooth.name") + " " + I18n.translateToLocal ("item.stone" + stoneType.getName () + ".name");
		else if (stack.getItem ().getRegistryName ().getResourcePath ().startsWith ("brick"))
			return I18n.translateToLocal ("item.stone" + stoneType.getName () + ".name") + " " + I18n.translateToLocal ("display.brick.name");
		else if (stack.getItem ().getRegistryName ().getResourcePath ().startsWith ("chisel"))
			return I18n.translateToLocal ("display.chisel.name") + " " + I18n.translateToLocal ("item.stone" + stoneType.getName () + ".name");
		else if (stack.getItem ().getRegistryName ().getResourcePath ().startsWith ("dirt"))
			return I18n.translateToLocal ("item.stone" + stoneType.getName () + ".name") + " " + I18n.translateToLocal ("item.dirt.name");
		else if (stack.getItem ().getRegistryName ().getResourcePath ().startsWith ("grass"))
			return I18n.translateToLocal ("item.stone" + stoneType.getName () + ".name") + " " + I18n.translateToLocal ("item.grass.name");
		else if (stack.getItem ().getRegistryName ().getResourcePath ().startsWith ("sand"))
			return I18n.translateToLocal ("item.stone" + stoneType.getName () + ".name") + " " + I18n.translateToLocal ("item.sand.name");
		else if (stack.getItem ().getRegistryName ().getResourcePath ().startsWith ("gravel"))
			return I18n.translateToLocal ("item.stone" + stoneType.getName () + ".name") + " " + I18n.translateToLocal ("item.gravel.name");
